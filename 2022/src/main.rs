...
fn main() {
    ...
    // // println!("Day 16");
    // // let input = String::from_utf8_lossy(include_bytes!("../input/day_16.txt"));
    // // println!("{}", day_16::day_16_1(&input));
    // // println!("{}", day_16::day_16_2(&input));
    // // println!();

    // println!("Day 17");
    // let input = String::from_utf8_lossy(include_bytes!("../input/day_17.txt"));
    // println!("{}", day_17::day_17_1(&input));
    // // println!("{}", day_17::day_17_2(&input));
    // println!();
